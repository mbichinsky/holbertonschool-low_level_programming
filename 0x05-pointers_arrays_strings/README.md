...
** 0-main.c - 8-main.c are provided test files for testing use.
** holberton.h is the header file which contains the new functions that are created
** all problems are using the betty c-coding style
